...
<html>
	...
	<center>
	<body>
		<center><font class="tabletop">添加进货</font></center><br/><br/>
		<!--<c:set var="stu" value="${sessionScope.stu_info }"/>-->
		<form action="IntoGoodsAction!addIntoGoods" target="mainFrame" onsubmit="javascript:window.close();">
		<table class="ta" width="200px">	
		<tr >
			<td>进货时间</td>
			<td><input type="text" name="intoGoods.intoDate" id="intoDate"/></td>
		</tr>
		<tr >
			<td>进货数量</td>
