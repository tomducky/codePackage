...
<html>
	...
	<body>
		...
		<tr >
			<td>商品名</td>
			<td><input type="text" name="goods.name" value="${request.goods.name }"/></td>
		</tr>
		<tr >
			<td>进货价格</td>
			<td><input type="text" name="goods.inputPrise" value="${request.goods.inputPrise }"/>
			<input type="hidden" name="goods.id" value="${request.goods.id }"/>
			</td>
		</tr>
		<tr >
			<td>卖出价格</td>
			<td><input type="text" name="goods.outputPrise" value="${request.goods.outputPrise }"/></td>
		</tr>
		<tr >
			<td>剩余数量</td>
			<td><input type="text" name="goods.remainNum" value="${request.goods.remainNum }"/></td>
		</tr>
		<tr >
			<td>来自厂商</td>
			<td>
